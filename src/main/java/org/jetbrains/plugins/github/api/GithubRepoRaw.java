...
class GithubRepoRaw implements DataConstructor
{
	...
	public GithubRepoOrg createRepoOrg()
	{
		return new GithubRepoOrg(name, description, isPrivate, isFork, htmlUrl, cloneUrl, defaultBranch,
				owner.createUser(), permissions.create());
	}
	...
	public GithubRepoDetailed createRepoDetailed()
	{
		...
		return new GithubRepoDetailed(name, description, isPrivate, isFork, htmlUrl, cloneUrl, defaultBranch,
				owner.createUser(), parent, source);
	}

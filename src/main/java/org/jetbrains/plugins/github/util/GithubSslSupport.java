...
public class GithubSslSupport
{
	...
	public boolean askIfShouldProceed(final String host)
	{
		...
		int choice = Messages.showIdeaMessageDialog(null, "The security certificate of " + host + " is not trusted. Do" +
				" you want to proceed anyway?", "Not Trusted Certificate", new String[]{
				BACK_TO_SAFETY,
				TRUST
		}, 0, Messages.getErrorIcon(), null);
